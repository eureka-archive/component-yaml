...
/**
 * Copyright (c) 2012-2016 Romain Cottard
 *
 ...
 * Rename class / methods for Eureka Framework.
 * Remove functions.
 *
...
namespace Eureka\Component\Yaml;
...
class Yaml
{
     ...
     * @var bool
     */
    protected $setting_dump_force_quotes = false;
     ...
     * @var bool
     */
    protected $setting_use_syck_is_possible = false;
     ...
     * Class constructor
     *
     * @param boolean $canUseSyck
     * @param boolean $forceQuoteDump
     * @return Yaml
     */
    public function __construct($canUseSyck = false, $forceQuoteDump = false)
    {
        $this->setting_use_syck_is_possible = $canUseSyck;
        $this->setting_dump_force_quotes    = $forceQuoteDump;
    }

    /**
     * Parse source file & return data.
     *
     * @param string $file
     * @return array
     */
    ...
    {
        $Source = $this->loadFromSource($file);

        return $this->loadWithSource($Source);
    }

    /**
     * Parse input string & return data.
     *
     * @param string $input
     * @return array
     */
     ...
     * @param  string $indent The indent of the current level
     */
